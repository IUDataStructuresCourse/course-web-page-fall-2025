...
| Oct. 29    | [Graphs and Breadth-first Search](./lectures/graphs-bfs.md)  | Ch. 9 sec. 1,3                                               | Homework: [Search is O(n) in Deduce](./SearchOn.md)                        |  [code](https://autograder.luddy.indiana.edu/web/project/2075)    |
...
| Nov. 5     | [Shortest Paths](./lectures/shortest-paths.md)               | Ch. 9 sec. 3                                                 | Homework: [Insertion Sort Correct](./LabInsertionSort.md) | [code](https://autograder.luddy.indiana.edu/web/project/2081)     |
| Nov. 7     | —                                                            |                                                              | Lab: [Connected Components](./ConnectedComponents.md)     |  [code](https://autograder.luddy.indiana.edu/web/project/1800), [test](https://autograder.luddy.indiana.edu/web/project/1803)     |
